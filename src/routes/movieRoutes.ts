...
import { getMovies, addMovie, updateMovie, deleteMovie, searchMovies, uploadPoster } from '../controllers/movieController';
 ...
 */
router.post('/', authMiddleware, roleMiddleware('Admin'), uploadPoster, addMovie);
